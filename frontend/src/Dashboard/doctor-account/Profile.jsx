...
export const Profile = ({ doctorData }) => {
  const [formData, setFormData] = useState({
    ...
    experiences: [
      // { tartingDate: "", endingDate: "", position: "", hospital: "" },
    ],
    timeSlots: [],
    about: "",
    photo: null,
    ...
    <div>
      ...
      <form action="">
            ...
            <div key={index}>
              <div>
                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                  ...
                  <div>
                    <p className="form_label">Ending Times*</p>
                    <input
                      type="time"
                      name="startingTime"
        ...
        <div className="mb-5 flex items-center gap-3">
          {formData.photo && (
            <figure className="w-[60px] h-[60px] rounded-full border-2 broder-solid border-primaryColor flex items-center justify-center">
              <img
                src={formData.photo}
                alt=""
